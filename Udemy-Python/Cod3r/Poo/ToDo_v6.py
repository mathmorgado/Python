...
class TarefaRecorrente(Tarefa):
    ...
    def concluir(self):
        ...
        return TarefaRecorrente(self.descricao, novo_vencimeto, self.dias)
def main():
    ...
    casa.add(TarefaRecorrente('Trocar lençol', datetime.now(), dias=10))
    casa.add(casa.procurar('Trocar lençol').concluir())
